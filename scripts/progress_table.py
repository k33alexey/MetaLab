...
SHORT_NAMES = {
    ...
    11: "Компоновка и печать",
    12: "Редакторы компоновки",
    13: "Данные приложения",
    14: "Задания и эксплуатация",
    15: "Импорт данных",
    16: "Интеграции",
    17: "Интерфейс и локализация",
    18: "Качество и выпуск",
    19: "Оборудование",
...
def render_table(blocks: list[Block]) -> str:
    ...
    Двадцать блоков в два столбца: столько строк видно целиком, без прокрутки,
    а это и есть назначение таблички.
    """
    ...
    def counts(number: int) -> tuple[str, str]:
        ...
        if block is None or not block.iterations:
            return "—", "—"
