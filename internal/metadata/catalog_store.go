...
func databaseAttributeValue(storage attributeStorage, value Value) (any, error) {
	...
	case ObjectUUIDType, EnumerationType, CatalogType, DocumentType, CharacteristicTypesType, AccountType, CalculationTypeType, BusinessProcessType, TaskType, RoutePointType:
		return value.Data, nil
...
func decodeDatabaseAttribute(storage attributeStorage, raw json.RawMessage) (Value, error) {
	...
	switch storage.valueType {
	case StringType, DateType, ObjectUUIDType, EnumerationType, CatalogType, DocumentType, CharacteristicTypesType, AccountType, CalculationTypeType, BusinessProcessType, TaskType, RoutePointType:
